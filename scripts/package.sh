...
EXECUTABLE_NAME="CodeLauncher"
BUNDLE_ID="${BUNDLE_ID:-com.wtxeld.codelauncher}"
...
resolve_version() {
  ...
  echo "Usage: make package VERSION=1.0.0" >&2
  exit 1
}
...
<dict>
  ...
  <string>Copyright © ${CURRENT_YEAR} WtXeLd. All rights reserved.</string>
</dict>
</plist>
EOF
